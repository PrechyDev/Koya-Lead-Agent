...
CATALOGUE: dict[str, FailureKind] = {k.code: k for k in [
    ...
    FailureKind("budget_exhausted", "budget", "critical",
                ...
                "The app's Claude budget would be exceeded. Top up the Anthropic account, then add the same amount "
                "on the Spend page (developers)."),
    FailureKind("budget_requested", "budget", "warning", "",
                ...
                "raise its spend limit), then add the amount on the Spend page; that resolves this request."),
