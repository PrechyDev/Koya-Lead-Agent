...
3. `DEV_LIMITS=false` from the first deploy (full limits: 10 leads, 20 companies, $3.00 Claude per run; D-27/D-33, D-83). The owner sets any other value in Render → Environment if they want smaller runs.
